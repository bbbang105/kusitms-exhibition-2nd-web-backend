...
public class ElementControllerTest extends ControllerTestConfig {
    ...
    public void getElementTestResult_Success() throws Exception {
        ...
        GetElementTestResultResponse response = new GetElementTestResultResponse(
                "질소",
                "N2",
                "https://storage.cloud.google.com/kusitms-exhibition-bucket/element/질소.svg?authuser=4",
        ...
        resultActions.andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$.payload.imgUrl").value("https://storage.cloud.google.com/kusitms-exhibition-bucket/element/질소.svg?authuser=4"))
