...
public enum ElementTestResult {
    ...
    CO2(
            "이산화탄소",
            "CO2",
            "https://storage.googleapis.com/kusitms-exhibition-bucket/element/이산화탄소.svg",
    ...
    O2(
            "산소",
            "O2",
            "https://storage.googleapis.com/kusitms-exhibition-bucket/element/산소.svg",
    ...
    Ar(
            "아르곤",
            "Ar",
            "https://storage.googleapis.com/kusitms-exhibition-bucket/element/아르곤.svg",
    ...
    He(
            "헬륨",
            "He",
            "https://storage.googleapis.com/kusitms-exhibition-bucket/element/헬륨.svg",
