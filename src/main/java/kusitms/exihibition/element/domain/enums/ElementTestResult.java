...
public enum ElementTestResult {
    ...
    N2(
            "질소",
            "N2",
            "https://storage.cloud.google.com/kusitms-exhibition-bucket/element/질소.svg?authuser=4",
    ...
    CO2(
            "이산화탄소",
            "CO2",
            "https://storage.cloud.google.com/kusitms-exhibition-bucket/element/이산화탄소.svg?authuser=4",
    ...
    O2(
            "산소",
            "O2",
            "https://storage.cloud.google.com/kusitms-exhibition-bucket/element/산소.svg?authuser=4",
    ...
    Ar(
            "아르곤",
            "Ar",
            "https://storage.cloud.google.com/kusitms-exhibition-bucket/element/아르곤.svg?authuser=4",
    ...
    He(
            "헬륨",
            "He",
            "https://storage.cloud.google.com/kusitms-exhibition-bucket/element/헬륨.svg?authuser=4",
